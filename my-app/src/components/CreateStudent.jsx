    ...
    const removeAttachmentRow = (indexToRemove) => {
      ...
      const addStudentDetails=async (e)=>{
        ...
        for (const pair of formdata.entries()) {
          ...
          console.log(allData);
          let response = await addStudent(formdata);
        ...
        <MDBRow>
          <MDBCol>
            <MDBBreadcrumb className="bg-light rounded-3 p-3 mb-4">
              ...
              <MDBBreadcrumbItem active>Add Student</MDBBreadcrumbItem>
            </MDBBreadcrumb>
          </MDBCol>
        </MDBRow>
      <MDBRow>
      <MDBTypography className= " text-center" tag="h5" >Add Student</MDBTypography>
        <MDBCol md="8" className="mb-4">
          <MDBCard className="mb-4">
            ...
            <MDBCardBody>
                ...
                <MDBRow className="mb-4">
                  <MDBCol>
                    <MDBInput label='Student ITS No.' name="student_its_id" type='text' />
                  </MDBCol>
                  <MDBCol>
                ...
                <MDBRow className="mb-4">
                  <MDBCol>
                    <MDBInput label="Class Teacher Name" name = "class_teacher_name" type='text' />
                  </MDBCol>
                  <MDBCol>
                    <MDBInput label="Dini Teacher Name" name="dini_teacher_name" type='text' />
                  </MDBCol>
                </MDBRow>
